...
Deno.test('left right', () => {
    let t = new Treehouse('25512')
    assertEquals(2, t.right(0, 2))
    assertEquals(1, t.left(0, 2))

    assertEquals(1, t.right(0, 1))
    assertEquals(1, t.left(0, 1))

    assertEquals(1, t.right(0, 3))
    assertEquals(1, t.left(0, 3))

    t = new Treehouse('33549')
    assertEquals(2, t.left(0, 2))
    assertEquals(2, t.right(0, 2))
})
...
33549
35390`
    let t = new Treehouse(data)
    assertEquals(1, t.up(1, 2))
    assertEquals(1, t.left(1, 2))
    assertEquals(2, t.down(1, 2))
    assertEquals(2, t.right(1, 2))
...
33549
35390`
    t  = new Treehouse(data)
    assertEquals(2, t.up(3, 2))
    assertEquals(2, t.left(3, 2))
    assertEquals(1, t.down(3, 2))
    assertEquals(2, t.right(3, 2))
